...
gender = st.selectbox('Geneder',onehot_encoder_gender.classes_)
...
has_cr_card = st.selectbox('Haas Credit card',[0,1])
is_active_member = st.selectbox('Is Activity Member',[0,1])


input_data = pd.DataFrame({
    'CreditScore': [Credit_score],
    'Gender': [onehot_encoder_gender.transform([gender])[0]],
    'Age': [age],
    'Tenure': [tenure],
    'Balance': [balance],
